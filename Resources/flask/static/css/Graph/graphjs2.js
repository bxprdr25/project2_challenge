    ...
    //Read the data
    d3.csv("../Data/minwage_forgraphv2.csv", function(data) {
        console.log(data);
...
//   .text("Effective Minimum Wage (2020 USD)"); 
  ...
  var line2 = svg
    ...
    .append("path")
      ...
      .attr("stroke", function(d){ return myColor("Alaska") })
      .style("stroke-width", 4)
      .style("fill", "none")
  ...
  function update(selectedGroup2) {
    ...
    // Create new data with the selection?
    var dataFilter2 = data.map(function(d){return {Year: d.Year, value:d[selectedGroup2]} })
